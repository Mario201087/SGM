...
<body>
    ...
    <div class="col-12 d-flex justify-content-between mt-3 mx-auto" style='height: 6vh;'>
        <btn class="btn-secondary mr-1 text-center" onclick="kolejnosc()"  style='width: 33%;'>Kolejność</btn>
        <btn class="btn-primary text-center" style='width: 33%;' onclick="korekta()"  >Korekta</btn>
        <btn class="btn-primary ml-1 text-center" style='width: 33%;' onclick="stan()" >Stany</btn>
    </div>
