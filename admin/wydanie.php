...
<body>
    ...
    <div class="col-12 d-flex justify-content-between mt-3 mx-auto" style='height: 6vh;'>
        <btn class="btn-primary text-center" onclick="magazyn()"  style='width: 33%;'>Przyjecie</btn>
        <btn class="btn-secondary mr-1 text-center active" style='width: 33%;' onclick="wydanie()"  >Wydanie</btn>
        <btn class="btn-primary text-center" style='width: 33%;' onclick="stany()" >Stany</btn>
    </div>
